...
from whatsapp_nlp_llm.utils import preprocessor, helper # local file functions
import matplotlib.pyplot as plt
import seaborn as sns
from whatsapp_nlp_llm.logger import logging
...
if uploaded_file is not None:
    try:
        ...
        # Call the preprocess function to give df
        df = preprocessor.parse_whatsapp_chat(data)
        ...
        if st.sidebar.button("Show Analysis"):
            try:
                # Display basic stats in 4 columns
